    ...
    <section id="services" className="relative py-12 md:py-28 px-6 md:px-14" style={{ background: '#050d1a' }}>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-500 text-sm mt-5 max-w-lg leading-relaxed">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-start gap-3 mb-2">
                  ...
                  <span className="text-xs px-2 py-0.5 rounded-full text-slate-500 border border-white/[0.08] flex-shrink-0 mt-0.5">
                    {service.category}
                  </span>
                </div>
                <p className="text-slate-500 text-sm leading-relaxed max-w-xl">{service.description}</p>
              ...
              <div className="flex items-center gap-4 flex-shrink-0">
                <div className="text-right">
                  ...
                  <div className="text-slate-600 text-xs tracking-widest uppercase mt-1">{service.metricLabel}</div>
                </div>
                <div
