        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-24 items-start mb-10 md:mb-24">
          ...
          >
            ...
            <div className="mt-8 space-y-2">
              ...
              <div className="text-slate-200 text-[11px] tracking-[0.3em] uppercase pl-5">
          ...
          <div className="flex-1 pt-0 lg:pt-16">
            ...
            <motion.p
              {...fadeUp(0.2)}
              className="text-slate-200 leading-relaxed mb-5 max-w-lg"
            ...
            <motion.p
              {...fadeUp(0.28)}
              className="text-slate-200 leading-relaxed max-w-lg"
              style={{ fontSize: 'clamp(0.875rem, 1.2vw, 1rem)' }}
            >
