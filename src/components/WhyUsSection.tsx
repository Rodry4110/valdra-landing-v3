      ...
      <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                {card.title === 'Fast Turnaround' && (
                  <div className="flex items-baseline gap-2 mb-3">
                    ...
                    <span className="text-slate-200 text-[11px] tracking-widest uppercase">Day Delivery</span>
                  </div>
                )}

                {/* Body */}
                <p className="text-slate-200 text-sm leading-relaxed relative z-10" style={{ maxWidth: card.wide ? '520px' : undefined }}>
                  {card.body}
                </p>
        ...
        >
          ...
          {tableRows.map((row, i) => (
            ...
            >
              <div className="text-slate-200 text-sm font-medium">{row.feature}</div>
              ...
              <div className="flex items-center justify-center gap-1.5">
                ...
                <span className="text-xs text-slate-200">{row.agency}</span>
              </div>
              ...
              <div className="flex items-center justify-center gap-1.5">
                ...
                <span className="text-xs text-slate-200">{row.freelancer}</span>
              </div>
            </motion.div>
          ))}
        </motion.div>
